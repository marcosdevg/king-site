 ...
 */
router.post('/test-n8n-notify', async (req, res) => {
    try {
...
router.post('/create-payment-intent', async (req, res) => {
    try {
        const { subtotal, shippingCost, discount = 0, currency = 'brl', metadata = {}, } = (req.body ?? {});
        ...
        const safeDiscount = typeof discount === 'number' && discount > 0 && discount < subtotal
            ? discount
            : 0;
